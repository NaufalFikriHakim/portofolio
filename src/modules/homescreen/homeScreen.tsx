...
import { Card, CardHeader, CardBody, CardFooter, List, ListItem, ListIcon, OrderedList, UnorderedList, } from '@chakra-ui/react'
...
export default function HomeScreenModule() {
    return (
        <Flex direction="column" w="100%" gap={2} mb={3}>
                                ...
                                <GridItem colSpan={5} ><UnorderedList>
                                    ...
                                    <ListItem><Text as="b">Task:</Text>
                                        <OrderedList>
                                            ...
                                            <ListItem>
                                                Deploy existing program and runner using Google Cloud
                                            </ListItem>
                        ...
                        <GridItem colSpan={2} ><Carousel>
                                    ...
                                    <ListItem><Text as="b">Task:</Text>
                                        <OrderedList>
                                            ...
                                            <ListItem>
                                                Implement <div style={{display: "inline-block", border: "1px solid gray", borderRadius: "5px", backgroundColor: "#0F1B38", fontWeight: "bold", color: "white", padding:"2px"}}>CI/CD</div> using GitHub CI/CD
                                            </ListItem>
                                            <ListItem>

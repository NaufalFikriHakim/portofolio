...
export default function CoverComponent() {
    ...
    return (
        <Box w='100%' paddingBlockStart={150}height={500}>
            <Center>
                <Heading size="3xl">
            ...
            <Center pt={5}>
                <Flex>
                    <a href="https://github.com/NaufalFikriHakim">
                        <img src="/github-mark.svg" width="60px" height="60px" alt="" />
                    </a>
                    <a href="https://gitlab.com/naufal.fikri11">
                        <img src="https://images.ctfassets.net/xz1dnu24egyd/4V92fFTJOIlTPHHzSdfxem/3fdc9f0d82f08ed4c355c6e4126b870c/gitlab-logo-600.svg" width="60px" height="60px" alt="" />
                    </a>
                    <a href="https://www.linkedin.com/in/naufal-fikri-hakim/">
                        <img src="/icons8-linkedin-50.svg" width="60px" height="60px" alt="" />
                    </a>
                </Flex>
            </Center>
            <Center pt={10} pb={20}>
